...
Script.fromMegacoindString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected, witness, amount) {
    var amount = amount || 0;
    var scriptSig = Script.fromMegacoindString(vector[0]);
    var scriptPubkey = Script.fromMegacoindString(vector[1]);
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            map[txid + ':' + txoutnum] = Script.fromMegacoindString(scriptPubKeyStr);
          });
