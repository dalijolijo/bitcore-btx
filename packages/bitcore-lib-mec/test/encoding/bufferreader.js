...
describe('BufferReader', function() {
  ...
  describe('#readUInt64LEBN', function() {
    ...
    it('should return 10MEC', function() {
      var tenmec = 10 * 1e8;
      var tenmecBuffer = new Buffer('00ca9a3b00000000', 'hex');
      var br = new BufferReader(tenmecBuffer);
      br.readUInt64LEBN().toNumber().should.equal(tenmec);
    });
