...
/**
 * Internal function to transform a MEC string amount into satoshis
 *
 * @param {string} amount - Amount MEC string
 * @throws {TypeError} Invalid amount
...
URI.prototype._parseAmount = function(amount) {
  ...
  return Unit.fromMEC(amount).toSatoshis();
};
...
URI.prototype.toString = function() {
  var query = {};
  if (this.amount) {
    query.amount = Unit.fromSatoshis(this.amount).toMEC();
  }
  if (this.message) {
